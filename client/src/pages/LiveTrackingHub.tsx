        ...
        {activeTab === 'active' && (
          <div className="space-y-3 anim-fade-in">
            {activeTracks.length === 0 ? (
              <div className="bg-white rounded-3xl p-8 border border-slate-200/90 shadow-2xs text-center space-y-3 mt-2">
              ...
              <div className="space-y-2.5">
                ...
                <div className="space-y-2">
                  {activeTracks.map(track => (
                    <div
                      key={track.id}
                      className="bg-white rounded-2xl p-3 sm:p-3.5 border border-emerald-300 shadow-sm shadow-emerald-500/10 flex items-center justify-between gap-2.5 anim-fade-in"
                    >
                      <div
                      ...
                      {/* Digits & Compact Icon Actions */}
                      <div className="flex items-center gap-1.5 shrink-0">
                        {/* Clock Digits */}
                        <div className="bg-slate-900 text-emerald-400 font-mono font-black text-xs sm:text-sm px-2.5 py-1.5 rounded-xl shadow-xs tracking-wider">
