...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 h-screen fixed left-0 top-0 bg-[#0F172A]/90 backdrop-blur-xl border-r border-slate-800 flex flex-col justify-between z-30 select-none">
      {/* App Header / Brand */}
      <div>
